...
def format_voice_prompt(base_prompt: str, notion_context: str) -> str:
    """Append Notion-derived context to the base system prompt."""
    if not notion_context or not notion_context.strip():
        return base_prompt
    return f"{base_prompt}\n\n[Context from your workspace: {notion_context}]"
